...
`,C=e=>Object(r.createElement)(O,{className:e.className,headingColor:e.headingColor,hasPaperStyle:e.hasPaperStyle},e.headingText&&Object(r.createElement)(v,{level:e.headingLevel,className:e.headingClassName},e.headingIcon&&Object(r.createElement)(x,{icon:e.headingIcon,color:e.headingIconColor,size:e.headingIconSize}),e.headingText),e.children);C.propTypes={className:l.a.string,headingLevel:l.a.number,headingClassName:l.a.string,headingColor:l.a.string,headingIcon:l.a.string,headingIconColor:l.a.string,headingIconSize:l.a.string,headingText:l.a.string,hasPaperStyle:l.a.bool,children:l.a.any},C.defaultProps={className:"yoast-section",headingLevel:2,hasPaperStyle:!0};var w=C,_=o(84),j=o.n(_);function E(e){return c()(e)`
		display: inline-flex;
		align-items: center;
...
`;class Lt extends a.a.Component{getActionBlock(e,t){const o=Object(u.makeOutboundLink)(e);return"true"===t?Object(r.createElement)(It,null,Object(r.createElement)(o,{href:this.props.courseUrl},this.props.ctaButtonData.ctaButtonCopy)):Object(r.createElement)(It,null,Object(r.createElement)(o,{href:this.props.ctaButtonData.ctaButtonUrl},this.props.ctaButtonData.ctaButtonCopy),Object(r.createElement)(Bt,{href:this.props.courseUrl},this.props.readMoreLinkText))}render(){const e="regular"===this.props.ctaButtonData.ctaButtonType?Nt:Rt;return Object(r.createElement)(n.Fragment,null,Object(r.createElement)(Mt,null,Object(r.createElement)(zt,{dangerouslySetInnerHTML:{__html:this.props.description}})),this.getActionBlock(e,this.props.isBundle))}}var Dt=Lt;Lt.propTypes={description:l.a.string,courseUrl:l.a.string,ctaButtonData:l.a.object,readMoreLinkText:l.a.string,isBundle:l.a.string},Lt.defaultProps={description:"",courseUrl:"",ctaButtonData:{},readMoreLinkText:"",isBundle:""};var At=o(33),Ft=o.n(At);const Ut=j()([T,k,S])(c.a.button`
	...
	`),Ht=e=>{const{children:t,icon:o,textColor:n}=e,a=Ft()(e,"icon");return Object(r.createElement)(Ut,a,Object(r.createElement)(y,{icon:o,color:n}),t)};Ht.propTypes={type:l.a.string,icon:l.a.string.isRequired,textColor:l.a.string,textFontSize:l.a.string,backgroundColor:l.a.string,borderColor:l.a.string,hoverColor:l.a.string,hoverBackgroundColor:l.a.string,hoverBorderColor:l.a.string,activeColor:l.a.string,activeBackgroundColor:l.a.string,activeBorderColor:l.a.string,focusColor:l.a.string,focusBackgroundColor:l.a.string,focusBorderColor:l.a.string,focusBoxShadowColor:l.a.string,children:l.a.oneOfType([l.a.arrayOf(l.a.node),l.a.node,l.a.string]).isRequired},Ht.defaultProps={type:"button",textColor:d.colors.$color_blue,textFontSize:"inherit",backgroundColor:"transparent",borderColor:"transparent",hoverColor:d.colors.$color_white,hoverBackgroundColor:d.colors.$color_blue,hoverBorderColor:d.colors.$color_button_border_hover,activeColor:d.colors.$color_white,activeBackgroundColor:d.colors.$color_blue,activeBorderColor:d.colors.$color_button_border_active,focusColor:d.colors.$color_white,focusBackgroundColor:d.colors.$color_blue,focusBorderColor:d.colors.$color_blue,focusBoxShadowColor:d.colors.$color_blue_dark};var Wt=Ht;const Vt=e=>{const{children:t,icon:o,iconColor:n}=e;let a=y;t&&(a=function(e){return c()(e)`
		...
		flex-shrink: 0;
	`}(a));const s=Ft()(e,"icon");return Object(r.createElement)(N,s,Object(r.createElement)(a,{icon:o,color:n}),t)};Vt.propTypes={icon:l.a.string.isRequired,iconColor:l.a.string,children:l.a.oneOfType([l.a.arrayOf(l.a.node),l.a.node,l.a.string])},Vt.defaultProps={iconColor:"#000"};var Kt=Vt,Gt=o(34);const Yt=c.a.p`
	text-align: center;
	margin: 0 0 16px;
...
`;Ho.defaultProps={max:1,value:0,progressColor:d.colors.$color_good,backgroundColor:d.colors.$color_background_light,borderColor:d.colors.$color_input_border,"aria-hidden":"true"},Ho.propTypes={max:l.a.number,value:l.a.number,progressColor:l.a.string,backgroundColor:l.a.string,borderColor:l.a.string,"aria-hidden":l.a.string};var Wo=Ho;const{stripTagsFromHtmlString:Vo}=u.strings,Ko=["a","b","strong","em","i","span","p","ul","ol","li","div"],Go=c.a.li`
	display: table-row;
	font-size: 14px;
`,Yo=c.a.span`
	display: table-cell;
...
`;Zo.propTypes={scoreColor:l.a.string.isRequired};const Xo=c()(Yo)`
	padding-left: 8px;
	width: 100%;
`,Jo=c()(Yo)`
	font-weight: 600;
	text-align: right;
	padding-left: 16px;
`,Qo=e=>Object(r.createElement)(Go,{className:""+e.className},Object(r.createElement)(Zo,{className:e.className+"-bullet",scoreColor:e.scoreColor}),Object(r.createElement)(Xo,{className:e.className+"-text",dangerouslySetInnerHTML:{__html:Vo(e.html,Ko)}}),e.value&&Object(r.createElement)(Jo,{className:e.className+"-score"},e.value));Qo.propTypes={className:l.a.string.isRequired,scoreColor:l.a.string.isRequired,html:l.a.string.isRequired,value:l.a.number};const er=c.a.ul`
	display: table;
	box-sizing: border-box;
	list-style: none;
	max-width: 100%;
	...
	margin: 8px 0;
	padding: 0 8px;
`,tr=e=>Object(r.createElement)(er,{className:e.className,role:"list"},e.items.map((t,o)=>Object(r.createElement)(Qo,{className:e.className+"__item",key:o,scoreColor:t.color,html:t.html,value:t.value})));tr.propTypes={className:l.a.string,items:l.a.arrayOf(l.a.shape({color:l.a.string.isRequired,html:l.a.string.isRequired,value:l.a.number}))},tr.defaultProps={className:"score-assessments"};var or=tr;const rr=c.a.div`
	margin: 8px 0;
...
`,nr=c.a.span`
	...
	background-color: ${e=>e.progressColor};
	height: 100%;
`;nr.propTypes={progressWidth:l.a.number.isRequired,progressColor:l.a.string.isRequired};const ar=e=>{let t=0;for(let o=0;o<e.items.length;o++)e.items[o].value=Math.max(e.items[o].value,0),t+=e.items[o].value;return t<=0?null:Object(r.createElement)(rr,{className:e.className,barHeight:e.barHeight},e.items.map((o,n)=>Object(r.createElement)(nr,{className:e.className+"__part",key:n,progressColor:o.color,progressWidth:o.value/t*100})))};ar.propTypes={className:l.a.string,items:l.a.arrayOf(l.a.shape({value:l.a.number.isRequired,color:l.a.string.isRequired})),barHeight:l.a.string},ar.defaultProps={className:"stacked-progress-bar",barHeight:"24px"};var sr=ar;const lr=c.a.div.attrs({})`
	flex: 0 1 100%;
...
`,hr=e=>{const{label:t,helpLink:o,...n}=e;return Object(r.createElement)(ir,null,Object(r.createElement)(ur,null,Object(r.createElement)(pr,{htmlFor:n.id},t),o),Object(r.createElement)(cr,B()({},n,{autoComplete:"off"})))};hr.propTypes={type:l.a.string,id:l.a.string.isRequired,label:l.a.string,helpLink:l.a.node},hr.defaultProps={type:"text",label:"",helpLink:null};var fr=hr;class br extends a.a.Component{constructor(e){super(e),this.setReference=this.setReference.bind(this)}render(){return Object(r.createElement)("textarea",B()({ref:this.setReference,name:this.props.name,value:this.props.value,onChange:this.props.onChange},this.props.optionalAttributes))}setReference(e){this.ref=e}componentDidUpdate(){this.props.hasFocus&&this.ref.focus()}}br.propTypes={name:l.a.string,value:l.a.string,onChange:l.a.func,optionalAttributes:l.a.object,hasFocus:l.a.bool},br.defaultProps={name:"textarea",value:"",hasFocus:!1,onChange:null,optionalAttributes:{}};var mr=br;class gr extends a.a.Component{constructor(e){super(e),this.optionalAttributes=this.parseOptionalAttributes()}render(){return this.optionalAttributes=this.parseOptionalAttributes(),this.props.class&&(this.optionalAttributes.container.className=this.props.class),Object(r.createElement)("div",this.optionalAttributes.container,Object(r.createElement)(xo,{for:this.props.name,optionalAttributes:this.optionalAttributes.label},this.props.label),this.getTextField())}getTextField(){return!0===this.props.multiline?Object(r.createElement)("div",null,Object(r.createElement)(mr,{name:this.props.name,id:this.props.name,onChange:this.props.onChange,optionalAttributes:this.optionalAttributes.field,hasFocus:this.props.hasFocus,value:this.props.value}),this.props.explanation&&Object(r.createElement)("p",null,this.props.explanation)):Object(r.createElement)("div",null,Object(r.createElement)(uo,{name:this.props.name,id:this.props.name,type:"text",onChange:this.props.onChange,value:this.props.value,hasFocus:this.props.hasFocus,autoComplete:this.props.autoComplete,optionalAttributes:this.optionalAttributes.field}),this.props.explanation&&Object(r.createElement)("p",null,this.props.explanation))}parseOptionalAttributes(){const e={},t={},o={id:this.props.name};return Object.keys(this.props).forEach(function(r){r.startsWith("label-")&&(t[r.split("-").pop()]=this.props[r]),r.startsWith("field-")&&(o[r.split("-").pop()]=this.props[r]),r.startsWith("container-")&&(e[r.split("-").pop()]=this.props[r])}.bind(this)),{label:t,field:o,container:e}}}gr.propTypes={label:l.a.string.isRequired,name:l.a.string.isRequired,onChange:l.a.func.isRequired,value:l.a.string,optionalAttributes:l.a.object,multiline:l.a.bool,hasFocus:l.a.bool,class:l.a.string,explanation:l.a.string,autoComplete:l.a.string},gr.defaultProps={optionalAttributes:{},multiline:!1,hasFocus:!1,value:null,class:null,explanation:!1,autoComplete:null};var yr=gr;const vr=c.a.div`
	display: flex;
	width: 100%;
...
`,wr=c.a.span`
	...
	font-style: italic;
`;class _r extends a.a.Component{constructor(e){super(e),this.onClick=this.props.onToggleDisabled,this.onKeyUp=this.props.onToggleDisabled,this.setToggleState=this.setToggleState.bind(this),this.handleOnKeyDown=this.handleOnKeyDown.bind(this),!0!==e.disable&&(this.onClick=this.setToggleState.bind(this),this.onKeyUp=this.setToggleState.bind(this))}setToggleState(e){"keyup"===e.type&&32!==e.keyCode||this.props.onSetToggleState(!this.props.isEnabled)}handleOnKeyDown(e){32===e.keyCode&&e.preventDefault()}render(){return Object(r.createElement)(vr,null,this.props.labelText&&Object(r.createElement)(xr,{id:this.props.id,onClick:this.onClick},this.props.labelText),Object(r.createElement)(Or,{isEnabled:this.props.isEnabled,onKeyDown:this.handleOnKeyDown,onClick:this.onClick,onKeyUp:this.onKeyUp,tabIndex:"0",role:"checkbox","aria-labelledby":this.props.id,"aria-checked":this.props.isEnabled,"aria-disabled":this.props.disable},Object(r.createElement)(Cr,{isEnabled:this.props.isEnabled})),this.props.showToggleStateLabel&&Object(r.createElement)(wr,{"aria-hidden":"true"},this.props.isEnabled?Object(U.__)("On","wordpress-seo"):Object(U.__)("Off","wordpress-seo")))}}_r.propTypes={isEnabled:l.a.bool,onSetToggleState:l.a.func,disable:l.a.bool,onToggleDisabled:l.a.func,id:l.a.string.isRequired,labelText:l.a.string,showToggleStateLabel:l.a.bool},_r.defaultProps={isEnabled:!1,onSetToggleState:()=>{},labelText:"",disable:!1,onToggleDisabled:()=>{},showToggleStateLabel:!0};var jr=_r;function Er(e){return c()(e)`
		display: inline-flex;
		align-items: center;
		justify-content: center;
		vertical-align: middle;
	...
	`}const kr=e=>{let{className:t,onClick:o,type:n,children:a,isExpanded:s}=e;return Object(r.createElement)("button",{className:t,onClick:o,type:n,"aria-expanded":s},Object(r.createElement)("span",null,a))};kr.propTypes={className:l.a.string,onClick:l.a.func,type:l.a.string,isExpanded:l.a.bool,children:l.a.oneOfType([l.a.arrayOf(l.a.node),l.a.node,l.a.string])},kr.defaultProps={type:"button"};const Sr=Er(c()(kr)`
		color: ${e=>e.textColor};
		background: ${e=>e.backgroundColor};
		min-width: 152px;
	...
	`);Sr.propTypes={backgroundColor:l.a.string,textColor:l.a.string,withTextShadow:l.a.bool},Sr.defaultProps={backgroundColor:d.colors.$color_green_medium_light,textColor:d.colors.$color_white,withTextShadow:!0};const Tr=c()(y)`
...
`,$r=(qr=c()(kr)`
	...
	`);var qr;$r.propTypes={backgroundColor:l.a.string,hoverColor:l.a.string,textColor:l.a.string},$r.defaultProps={backgroundColor:d.colors.$color_button_upsell,hoverColor:d.colors.$color_button_hover_upsell,textColor:d.colors.$color_black};const Nr=e=>{const{children:t}=e;return Object(r.createElement)($r,e,t,Object(r.createElement)(Tr,{icon:"caret-right",color:d.colors.$color_black,size:"16px"}))};Nr.propTypes={backgroundColor:l.a.string,hoverColor:l.a.string,textColor:l.a.string,children:l.a.oneOfType([l.a.arrayOf(l.a.node),l.a.node])};const Rr=c.a.a`
	align-items: center;
	justify-content: center;
	vertical-align: middle;
	color: ${d.colors.$color_black};
...
`,Lr=c.a.button`
	...
	padding: 0;
	cursor: pointer;
`;class Dr extends a.a.Component{constructor(e){super(e)}render(){return Object(r.createElement)(zr.a,{isOpen:this.props.isOpen,onRequestClose:this.props.onClose,role:"dialog",contentLabel:this.props.modalAriaLabel,overlayClassName:"yoast-modal__overlay "+this.props.className,className:"yoast-modal__content "+this.props.className,appElement:this.props.appElement,bodyOpenClassName:"yoast-modal_is-open"},Object(r.createElement)("div",null,this.props.heading&&Object(r.createElement)(Mr,{className:"yoast-modal__title"},this.props.heading),this.props.closeIconButton&&Object(r.createElement)(Lr,{type:"button",onClick:this.props.onClose,className:"yoast-modal__button-close-icon "+this.props.closeIconButtonClassName,"aria-label":this.props.closeIconButton},Object(r.createElement)(y,{icon:"times",color:d.colors.$color_grey_text}))),Object(r.createElement)("div",{className:"yoast-modal__inside"},this.props.children),this.props.closeButton&&Object(r.createElement)("div",{className:"yoast-modal__actions"},Object(r.createElement)("button",{type:"button",onClick:this.props.onClose,className:"yoast-modal__button-close "+this.props.closeButtonClassName},this.props.closeButton)))}}Dr.propTypes={children:l.a.any,className:l.a.string,isOpen:l.a.bool,onClose:l.a.func.isRequired,modalAriaLabel:l.a.string.isRequired,appElement:l.a.object.isRequired,heading:l.a.string,closeIconButton:l.a.string,closeIconButtonClassName:l.a.string,closeButton:l.a.string,closeButtonClassName:l.a.string},Dr.defaultProps={children:null,className:"",heading:"",closeIconButton:"",closeIconButtonClassName:"",closeButton:"",closeButtonClassName:"",isOpen:!1};var Ar=c()(Dr)`
...
`,Fr=e=>Object(r.createElement)("svg",B()({},e,{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 500 500"}),Object(r.createElement)("path",{d:"M80,0H420a80,80,0,0,1,80,80V500a0,0,0,0,1,0,0H80A80,80,0,0,1,0,420V80A80,80,0,0,1,80,0Z",fill:"#a4286a"}),Object(r.createElement)("path",{d:"M437.61,2,155.89,500H500V80A80,80,0,0,0,437.61,2Z",fill:"#6c2548"}),Object(r.createElement)("path",{d:"M74.4,337.3v34.9c21.6-.9,38.5-8,52.8-22.5s27.4-38,39.9-72.9l92.6-248H214.9L140.3, 236l-37-116.2h-41l54.4,139.8a57.54,57.54,0,0,1,0,41.8C111.2,315.6,101.3,332.3,74.4,337.3Z",fill:"#fff"}),Object(r.createElement)("circle",{cx:"368.33",cy:"124.68",r:"97.34",transform:"translate(19.72 296.97) rotate(-45)",fill:"#9fda4f"}),Object(r.createElement)("path",{d:"M416.2,39.93,320.46,209.44A97.34,97.34,0,1,0,416.2,39.93Z",fill:"#77b227"}),Object(r.createElement)("path",{d:"M294.78,254.75h0l-.15-.08-.13-.07h0a63.6,63.6,0,0,0-62.56,110.76h0l.07,0,.06,0h0a63.6,63.6,0,0,0,62.71-110.67Z",fill:"#fec228"}),Object(r.createElement)("path",{d:"M294.5,254.59,231.94,365.35A63.6,63.6,0,1,0,294.5,254.59Z",fill:"#f49a00"}),Object(r.createElement)("path",{d:"M222.31,450.07A38.16,38.16,0,0,0,203,416.83h0l0,0h0a38.18,38.18,0,1,0,19.41,33.27Z",fill:"#ff4e47"}),Object(r.createElement)("path",{d:"M202.9,416.8l-37.54,66.48A38.17,38.17,0,0,0,202.9,416.8Z",fill:"#ed261f"}));function Ur(e){return e.type&&"Tab"===e.type.tabsRole}function Hr(e){return e.type&&"TabPanel"===e.type.tabsRole}function Wr(e){return e.type&&"TabList"===e.type.tabsRole}function Vr(e,t,o){return t in e?Object.defineProperty(e,t,{value:o,enumerable:!0,configurable:!0,writable:!0}):e[t]=o,e}function Kr(e,t){return n.Children.map(e,(function(e){return null===e?null:function(e){return Ur(e)||Wr(e)||Hr(e)}(e)?t(e):e.props&&e.props.children&&"object"==typeof e.props.children?Object(n.cloneElement)(e,function(e){for(var t=1;t<arguments.length;t++){var o=null!=arguments[t]?arguments[t]:{},r=Object.keys(o);"function"==typeof Object.getOwnPropertySymbols&&(r=r.concat(Object.getOwnPropertySymbols(o).filter((function(e){return Object.getOwnPropertyDescriptor(o,e).enumerable})))),r.forEach((function(t){Vr(e,t,o[t])}))}return e}({},e.props,{children:Kr(e.props.children,t)})):e}))}function Gr(e,t){return n.Children.forEach(e,(function(e){null!==e&&(Ur(e)||Hr(e)?t(e):e.props&&e.props.children&&"object"==typeof e.props.children&&(Wr(e)&&t(e),Gr(e.props.children,t)))}))}var Yr,Zr=o(37),Xr=o.n(Zr),Jr=0;function Qr(){return"react-tabs-"+Jr++}function en(e){var t=0;return Gr(e,(function(e){Ur(e)&&t++})),t}function tn(){return(tn=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var o=arguments[t];for(var r in o)Object.prototype.hasOwnProperty.call(o,r)&&(e[r]=o[r])}return e}).apply(this,arguments)}function on(e){return e&&"getAttribute"in e}function rn(e){return on(e)&&"tab"===e.getAttribute("role")}function nn(e){return on(e)&&"true"===e.getAttribute("aria-disabled")}try{Yr=!("undefined"==typeof window||!window.document||!window.document.activeElement)}catch(e){Yr=!1}var an=function(e){var t,o;function r(){for(var t,o=arguments.length,r=new Array(o),n=0;n<o;n++)r[n]=arguments[n];return(t=e.call.apply(e,[this].concat(r))||this).tabNodes=[],t.handleKeyDown=function(e){if(t.isTabFromContainer(e.target)){var o=t.props.selectedIndex,r=!1,n=!1;32!==e.keyCode&&13!==e.keyCode||(r=!0,n=!1,t.handleClick(e)),37===e.keyCode||38===e.keyCode?(o=t.getPrevTab(o),r=!0,n=!0):39===e.keyCode||40===e.keyCode?(o=t.getNextTab(o),r=!0,n=!0):35===e.keyCode?(o=t.getLastTab(),r=!0,n=!0):36===e.keyCode&&(o=t.getFirstTab(),r=!0,n=!0),r&&e.preventDefault(),n&&t.setSelected(o,e)}},t.handleClick=function(e){var o=e.target;do{if(t.isTabFromContainer(o)){if(nn(o))return;var r=[].slice.call(o.parentNode.children).filter(rn).indexOf(o);return void t.setSelected(r,e)}}while(null!=(o=o.parentNode))},t}o=e,(t=r).prototype=Object.create(o.prototype),t.prototype.constructor=t,t.__proto__=o;var s=r.prototype;return s.setSelected=function(e,t){if(!(e<0||e>=this.getTabsCount())){var o=this.props;(0,o.onSelect)(e,o.selectedIndex,t)}},s.getNextTab=function(e){for(var t=this.getTabsCount(),o=e+1;o<t;o++)if(!nn(this.getTab(o)))return o;for(var r=0;r<e;r++)if(!nn(this.getTab(r)))return r;return e},s.getPrevTab=function(e){for(var t=e;t--;)if(!nn(this.getTab(t)))return t;for(t=this.getTabsCount();t-- >e;)if(!nn(this.getTab(t)))return t;return e},s.getFirstTab=function(){for(var e=this.getTabsCount(),t=0;t<e;t++)if(!nn(this.getTab(t)))return t;return null},s.getLastTab=function(){for(var e=this.getTabsCount();e--;)if(!nn(this.getTab(e)))return e;return null},s.getTabsCount=function(){return en(this.props.children)},s.getPanelsCount=function(){return e=this.props.children,t=0,Gr(e,(function(e){Hr(e)&&t++})),t;var e,t},s.getTab=function(e){return this.tabNodes["tabs-"+e]},s.getChildren=function(){var e=this,t=0,o=this.props,r=o.children,s=o.disabledTabClassName,l=o.focus,i=o.forceRenderTabPanel,c=o.selectedIndex,d=o.selectedTabClassName,u=o.selectedTabPanelClassName;this.tabIds=this.tabIds||[],this.panelIds=this.panelIds||[];for(var p=this.tabIds.length-this.getTabsCount();p++<0;)this.tabIds.push(Qr()),this.panelIds.push(Qr());return Kr(r,(function(o){var r=o;if(Wr(o)){var p=0,h=!1;Yr&&(h=a.a.Children.toArray(o.props.children).filter(Ur).some((function(t,o){return document.activeElement===e.getTab(o)}))),r=Object(n.cloneElement)(o,{children:Kr(o.props.children,(function(t){var o="tabs-"+p,r=c===p,a={tabRef:function(t){e.tabNodes[o]=t},id:e.tabIds[p],panelId:e.panelIds[p],selected:r,focus:r&&(l||h)};return d&&(a.selectedClassName=d),s&&(a.disabledClassName=s),p++,Object(n.cloneElement)(t,a)}))})}else if(Hr(o)){var f={id:e.panelIds[t],tabId:e.tabIds[t],selected:c===t};i&&(f.forceRender=i),u&&(f.selectedClassName=u),t++,r=Object(n.cloneElement)(o,f)}return r}))},s.isTabFromContainer=function(e){if(!rn(e))return!1;var t=e.parentElement;do{if(t===this.node)return!0;if(t.getAttribute("data-tabs"))break;t=t.parentElement}while(t);return!1},s.render=function(){var e=this,t=this.props,o=(t.children,t.className),r=(t.disabledTabClassName,t.domRef),n=(t.focus,t.forceRenderTabPanel,t.onSelect,t.selectedIndex,t.selectedTabClassName,t.selectedTabPanelClassName,function(e,t){if(null==e)return{};var o,r,n={},a=Object.keys(e);for(r=0;r<a.length;r++)o=a[r],t.indexOf(o)>=0||(n[o]=e[o]);return n}(t,["children","className","disabledTabClassName","domRef","focus","forceRenderTabPanel","onSelect","selectedIndex","selectedTabClassName","selectedTabPanelClassName"]));return a.a.createElement("div",tn({},n,{className:Xr()(o),onClick:this.handleClick,onKeyDown:this.handleKeyDown,ref:function(t){e.node=t,r&&r(t)},"data-tabs":!0}),this.getChildren())},r}(n.Component);an.defaultProps={className:"react-tabs",focus:!1},an.propTypes={};var sn=function(e){var t,o;function r(t){var o;return(o=e.call(this,t)||this).handleSelected=function(e,t,n){var a=o.props.onSelect;if("function"!=typeof a||!1!==a(e,t,n)){var s={focus:"keydown"===n.type};r.inUncontrolledMode(o.props)&&(s.selectedIndex=e),o.setState(s)}},o.state=r.copyPropsToState(o.props,{},t.defaultFocus),o}o=e,(t=r).prototype=Object.create(o.prototype),t.prototype.constructor=t,t.__proto__=o;var n=r.prototype;return n.componentWillReceiveProps=function(e){this.setState((function(t){return r.copyPropsToState(e,t)}))},r.inUncontrolledMode=function(e){return null===e.selectedIndex},r.copyPropsToState=function(e,t,o){void 0===o&&(o=!1);var n={focus:o};if(r.inUncontrolledMode(e)){var a,s=en(e.children)-1;a=null!=t.selectedIndex?Math.min(t.selectedIndex,s):e.defaultIndex||0,n.selectedIndex=a}return n},n.render=function(){var e=this.props,t=e.children,o=(e.defaultIndex,e.defaultFocus,function(e,t){if(null==e)return{};var o,r,n={},a=Object.keys(e);for(r=0;r<a.length;r++)o=a[r],t.indexOf(o)>=0||(n[o]=e[o]);return n}(e,["children","defaultIndex","defaultFocus"])),r=this.state,n=r.focus,s=r.selectedIndex;return o.focus=n,o.onSelect=this.handleSelected,null!=s&&(o.selectedIndex=s),a.a.createElement(an,o,t)},r}(n.Component);function ln(){return(ln=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var o=arguments[t];for(var r in o)Object.prototype.hasOwnProperty.call(o,r)&&(e[r]=o[r])}return e}).apply(this,arguments)}sn.defaultProps={defaultFocus:!1,forceRenderTabPanel:!1,selectedIndex:null,defaultIndex:null},sn.propTypes={},sn.tabsRole="Tabs";var cn=function(e){var t,o;function r(){return e.apply(this,arguments)||this}return o=e,(t=r).prototype=Object.create(o.prototype),t.prototype.constructor=t,t.__proto__=o,r.prototype.render=function(){var e=this.props,t=e.children,o=e.className,r=function(e,t){if(null==e)return{};var o,r,n={},a=Object.keys(e);for(r=0;r<a.length;r++)o=a[r],t.indexOf(o)>=0||(n[o]=e[o]);return n}(e,["children","className"]);return a.a.createElement("ul",ln({},r,{className:Xr()(o),role:"tablist"}),t)},r}(n.Component);function dn(){return(dn=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var o=arguments[t];for(var r in o)Object.prototype.hasOwnProperty.call(o,r)&&(e[r]=o[r])}return e}).apply(this,arguments)}cn.defaultProps={className:"react-tabs__tab-list"},cn.propTypes={},cn.tabsRole="TabList";var un=function(e){var t,o;function r(){return e.apply(this,arguments)||this}o=e,(t=r).prototype=Object.create(o.prototype),t.prototype.constructor=t,t.__proto__=o;var n=r.prototype;return n.componentDidMount=function(){this.checkFocus()},n.componentDidUpdate=function(){this.checkFocus()},n.checkFocus=function(){var e=this.props,t=e.selected,o=e.focus;t&&o&&this.node.focus()},n.render=function(){var e,t=this,o=this.props,r=o.children,n=o.className,s=o.disabled,l=o.disabledClassName,i=(o.focus,o.id),c=o.panelId,d=o.selected,u=o.selectedClassName,p=o.tabIndex,h=o.tabRef,f=function(e,t){if(null==e)return{};var o,r,n={},a=Object.keys(e);for(r=0;r<a.length;r++)o=a[r],t.indexOf(o)>=0||(n[o]=e[o]);return n}(o,["children","className","disabled","disabledClassName","focus","id","panelId","selected","selectedClassName","tabIndex","tabRef"]);return a.a.createElement("li",dn({},f,{className:Xr()(n,(e={},e[u]=d,e[l]=s,e)),ref:function(e){t.node=e,h&&h(e)},role:"tab",id:i,"aria-selected":d?"true":"false","aria-disabled":s?"true":"false","aria-controls":c,tabIndex:p||(d?"0":null)}),r)},r}(n.Component);function pn(){return(pn=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var o=arguments[t];for(var r in o)Object.prototype.hasOwnProperty.call(o,r)&&(e[r]=o[r])}return e}).apply(this,arguments)}un.defaultProps={className:"react-tabs__tab",disabledClassName:"react-tabs__tab--disabled",focus:!1,id:null,panelId:null,selected:!1,selectedClassName:"react-tabs__tab--selected"},un.propTypes={},un.tabsRole="Tab";var hn=function(e){var t,o;function r(){return e.apply(this,arguments)||this}return o=e,(t=r).prototype=Object.create(o.prototype),t.prototype.constructor=t,t.__proto__=o,r.prototype.render=function(){var e,t=this.props,o=t.children,r=t.className,n=t.forceRender,s=t.id,l=t.selected,i=t.selectedClassName,c=t.tabId,d=function(e,t){if(null==e)return{};var o,r,n={},a=Object.keys(e);for(r=0;r<a.length;r++)o=a[r],t.indexOf(o)>=0||(n[o]=e[o]);return n}(t,["children","className","forceRender","id","selected","selectedClassName","tabId"]);return a.a.createElement("div",pn({},d,{className:Xr()(r,(e={},e[i]=l,e)),role:"tabpanel",id:s,"aria-labelledby":c}),n||l?o:null)},r}(n.Component);hn.defaultProps={className:"react-tabs__tab-panel",forceRender:!1,selectedClassName:"react-tabs__tab-panel--selected"},hn.propTypes={},hn.tabsRole="TabPanel";const fn=c.a.div`
	font-size: 1em;
...
`;fn.propTypes={tabsTextColor:l.a.string,tabsTextTransform:l.a.string,tabsFontSize:l.a.string,tabsFontWeight:l.a.string,tabsBaseWidth:l.a.string};class bn extends a.a.Component{getTabs(){return this.props.items.map(e=>Object(r.createElement)(un,{key:e.id},e.label))}getTabPanels(){return this.props.items.map(e=>Object(r.createElement)(hn,{key:e.id,tabIndex:"0"},e.content))}render(){return Object(r.createElement)(fn,{tabsTextColor:this.props.tabsTextColor,tabsTextTransform:this.props.tabsTextTransform,tabsFontSize:this.props.tabsFontSize,tabsFontWeight:this.props.tabsFontWeight,tabsBaseWidth:this.props.tabsBaseWidth},Object(r.createElement)(sn,{onSelect:this.props.onTabSelect},Object(r.createElement)(cn,null,this.getTabs()),this.getTabPanels()))}componentDidMount(){this.props.onTabsMounted()}}bn.propTypes={items:l.a.arrayOf(l.a.shape({id:l.a.string.isRequired,label:l.a.string.isRequired,content:l.a.object.isRequired})),tabsTextColor:l.a.string,tabsTextTransform:l.a.string,tabsFontSize:l.a.string,tabsFontWeight:l.a.string,tabsBaseWidth:l.a.string,onTabSelect:l.a.func,onTabsMounted:l.a.func},bn.defaultProps={items:[],tabsTextColor:d.colors.$color_grey_dark,tabsTextTransform:"none",tabsFontSize:"1.5em",tabsFontWeight:"200",tabsBaseWidth:"200px",onTabSelect:()=>{},onTabsMounted:()=>{}};var mn=bn,gn=o(64),yn=o.n(gn);const vn=c.a.div`
	display: flex;
	padding: 16px;
...
`;class Cn extends a.a.Component{render(){const{message:e}=this.props;return yn()(e)?null:Object(r.createElement)(vn,null,Object(r.createElement)(xn,{icon:"exclamation-triangle",size:"16px"}),Object(r.createElement)(On,null,e))}}Cn.propTypes={message:l.a.array},Cn.defaultProps={message:[]};var wn=Cn;const jn=c.a.div`
	position: relative;
...
`;function En(e){return Object(r.createElement)(jn,null,Object(r.createElement)(io,e))}En.propTypes={width:l.a.number,height:l.a.number,src:l.a.string.isRequired,title:l.a.string.isRequired,frameBorder:l.a.number,allowFullScreen:l.a.bool},En.defaultProps={width:560,height:315,frameBorder:0,allowFullScreen:!0};const kn=e=>{console.warn("The WordList component has been deprecated and will be removed in a future release.");const{title:t,classNamePrefix:o,words:n,header:a,footer:s}=e,l=Object(r.createElement)("ol",{className:o+"__list"},n.map(e=>Object(r.createElement)("li",{key:e,className:o+"__item"},e)));return Object(r.createElement)("div",{className:o},Object(r.createElement)("p",null,Object(r.createElement)("strong",null,t)),a,l,s)};kn.propTypes={words:l.a.array.isRequired,title:l.a.string.isRequired,header:l.a.string,footer:l.a.string,classNamePrefix:l.a.string},kn.defaultProps={classNamePrefix:"",header:"",footer:""};var Sn=kn;const Tn=c.a.ul`
	margin: 0;
 	padding: 0;
 	list-style: none;
 	position: relative;
...
`;Tn.propTypes={children:l.a.any};class $n extends a.a.Component{constructor(e){super(e)}getChildren(){return 1===this.props.children?[this.props.children]:this.props.children}render(){const e=this.getChildren();return Object(r.createElement)(Tn,{role:"list"},e)}}class qn extends $n{constructor(e){super(e),this.zebraProps=Object.assign({},e)}zebrafyChildren(){let e=this.props.children;this.props.children.map||(e=[e]),this.zebraProps.children=e.map((e,t)=>a.a.cloneElement(e,{background:t%2==1?d.colors.$color_white:d.colors.$color_background_light,key:t}))}render(){return this.zebrafyChildren(),Object(r.createElement)(Tn,B()({role:"list"},this.zebraProps))}}$n.propTypes={children:l.a.oneOfType([l.a.arrayOf(l.a.node),l.a.node])},$n.defaultProps={children:[]};const Nn=c.a.li`
	background: ${e=>e.background};
	display: flex;
	min-height: ${e=>e.rowHeight};
	align-items: center;
	justify-content: space-between;
`;Nn.propTypes={background:l.a.string,hasHeaderLabels:l.a.bool,rowHeight:l.a.string},Nn.defaultProps={background:d.colors.$color_white,hasHeaderLabels:!0},c()(Nn)`
