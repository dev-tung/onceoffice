...
`,G=a.a.div`
	color: #70757a;
`;function Q(e){const{shoppingData:t}=e;return Object(i.createElement)(W,null,t.rating>0&&Object(i.createElement)(H,{className:"yoast-shopping-data-preview__column"},Object(i.createElement)("div",{className:"yoast-shopping-data-preview__upper"},Object(u.__)("Rating","wordpress-seo")),Object(i.createElement)(G,{className:"yoast-shopping-data-preview__lower"},Object(i.createElement)("span",null,Object(D.round)(2*t.rating,1),"/10 "),Object(i.createElement)(E.StarRating,{rating:t.rating}),Object(i.createElement)("span",null," (",t.reviewCount,")"))),t.price&&Object(i.createElement)(q,{className:"yoast-shopping-data-preview__column"},Object(i.createElement)("div",{className:"yoast-shopping-data-preview__upper"},Object(u.__)("Price","wordpress-seo")),Object(i.createElement)(G,{className:"yoast-shopping-data-preview__lower",dangerouslySetInnerHTML:{__html:t.price}})),t.availability&&Object(i.createElement)(q,{className:"yoast-shopping-data-preview__column"},Object(i.createElement)("div",{className:"yoast-shopping-data-preview__upper"},Object(u.__)("Availability","wordpress-seo")),Object(i.createElement)(G,{className:"yoast-shopping-data-preview__lower"},Object(D.capitalize)(t.availability))))}var K=Q;Q.propTypes={shoppingData:c.a.shape({rating:c.a.number,reviewCount:c.a.number,availability:c.a.string,price:c.a.string}).isRequired};const X=["desktop","mobile"],{transliterate:Y,createRegexFromArray:J,replaceDiacritics:Z}=N.languageProcessing,ee=a()(b)`
...
`,ce=a.a.div`
	...
	line-height: 16px;
	vertical-align: top;
`;ce.displayName="BaseUrl";const pe=a()(ce)`
	display: flex;
	align-items: center;
	overflow: hidden;
...
`;pe.displayName="BaseUrlOverflowContainer";const de=a.a.span`
...
background: #f1f3f4;
min-width: 28px;
`;pe.displayName="SnippetPreview__BaseUrlOverflowContainer";const ge=a.a.div`
...
`,je=e=>{try{return decodeURI(e)}catch(t){return e}},Ce=e=>{let{screenMode:t}=e;return Object(i.createElement)("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",fill:"desktop"===t?"#4d5156":"#70757a",style:{width:"18px"}},Object(i.createElement)("path",{d:"M12 8c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0 2c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0 6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z"}))};Ce.propTypes={screenMode:c.a.string.isRequired};class Re extends o.PureComponent{constructor(e){super(e),this.state={title:e.title,description:e.description,isDescriptionPlaceholder:!0},this.setTitleRef=this.setTitleRef.bind(this),this.setDescriptionRef=this.setDescriptionRef.bind(this)}setTitleRef(e){this._titleElement=e}setDescriptionRef(e){this._descriptionElement=e}hasOverflowedContent(e){return Math.abs(e.clientHeight-e.scrollHeight)>=2}fitTitle(){const e=this._titleElement;if(this.hasOverflowedContent(e)){let t=this.state.title;const n=e.clientWidth/3;t.length>n&&(t=t.substring(0,n));const i=this.dropLastWord(t);this.setState({title:i})}}dropLastWord(e){const t=e.split(" ");return t.pop(),t.join(" ")}getTitle(){return this.props.title!==this.state.title?this.state.title+" ...":this.props.title}getDescription(){return this.props.description?U()(this.props.description,{length:156,separator:" ",omission:" ..."}):Object(u.__)("Please provide a meta description by editing the snippet below. If you don’t, Google will try to find a relevant part of your post to show in the search results.","wordpress-seo")}renderDate(){const e="desktop"===this.props.mode?"—":"－";return this.props.date&&Object(i.createElement)(we,{screenMode:this.props.mode},this.props.date," ",e," ")}addCaretStyles(e,t){const{mode:n,hoveredField:i,activeField:o}=this.props;return o===e?ie(t,w.colors.$color_snippet_active,n):i===e?ie(t,w.colors.$color_snippet_hover,n):t}getBreadcrumbs(e){const{breadcrumbs:t}=this.props;let n;try{n=new URL(e)}catch(t){return{hostname:e,breadcrumbs:""}}const i=je(n.hostname);let o=t||n.pathname.split("/");return o=o.filter(e=>Boolean(e)).map(e=>je(e)),{hostname:i,breadcrumbs:" › "+o.join(" › ")}}renderUrl(){const{url:e,onMouseUp:t,onMouseEnter:n,onMouseLeave:o,mode:s,faviconSrc:a,siteName:l}=this.props,c="mobile"===s,{hostname:p,breadcrumbs:d}=this.getBreadcrumbs(e),h=this.addCaretStyles("url",ce);return Object(i.createElement)(r.a.Fragment,null,Object(i.createElement)(E.ScreenReaderText,null,Object(u.__)("Url preview","wordpress-seo")+":"),Object(i.createElement)(h,null,Object(i.createElement)(pe,{onMouseUp:t.bind(null,"url"),onMouseEnter:n.bind(null,"url"),onMouseLeave:o.bind(null),screenMode:s},Object(i.createElement)(he,null,Object(i.createElement)(Oe,{src:a||"data:image/png;base64,",alt:""})),Object(i.createElement)(de,{screenMode:s},Object(i.createElement)(xe,{screenMode:s},l),Object(i.createElement)(ue,{screenMode:s},p),Object(i.createElement)(se,{screenMode:s},d),!c&&Object(i.createElement)(ye,null,Object(i.createElement)(Ce,{screenMode:s}))),c&&Object(i.createElement)(Ce,{screenMode:s}))))}componentWillReceiveProps(e){const t={};this.props.title!==e.title&&(t.title=e.title),this.props.description!==e.description&&(t.description=e.description),this.setState(t)}componentDidUpdate(){this.setState({isDescriptionPlaceholder:!this.props.description}),"mobile"===this.props.mode&&(clearTimeout(this.fitTitleTimeout),this.fitTitleTimeout=setTimeout(()=>{this.fitTitle()},10))}componentDidMount(){this.setState({isDescriptionPlaceholder:!this.props.description})}componentWillUnmount(){clearTimeout(this.fitTitleTimeout)}renderDescription(){const{wordsToHighlight:e,locale:t,onMouseUp:n,onMouseLeave:o,onMouseEnter:r,mode:s,mobileImageSrc:a}=this.props,l=this.renderDate(),c={isDescriptionPlaceholder:this.state.isDescriptionPlaceholder,onMouseUp:n.bind(null,"description"),onMouseEnter:r.bind(null,"description"),onMouseLeave:o.bind(null)};if("desktop"===s){const n=this.addCaretStyles("description",ge);return Object(i.createElement)(n,A()({},c,{ref:this.setDescriptionRef}),l,function(e,t,n,o){if(0===t.length)return n;let r=n;const s=[];t.forEach((function(t){t=t,s.push(t);const n=Y(t,e);n!==t&&s.push(n)}));const a=J(s,!1,"",!1);return r=r.replace(a,(function(e){return`{{strong}}${e}{{/strong}}`})),V()({mixedString:r,components:{strong:Object(i.createElement)("strong",null)}})}(t,e,this.getDescription()))}if("mobile"===s){const e=this.addCaretStyles("description",fe);return Object(i.createElement)(e,c,Object(i.createElement)(fe,{isDescriptionPlaceholder:this.state.isDescriptionPlaceholder,ref:this.setDescriptionRef},a&&Object(i.createElement)(me,null,Object(i.createElement)(be,{src:a,alt:""})),l,this.getDescription()))}return null}renderProductData(e){const{mode:t,shoppingData:n}=this.props;if(0===Object.values(n).length)return null;const o={availability:n.availability||"",price:n.price?Object(y.decodeHTML)(n.price):"",rating:n.rating||0,reviewCount:n.reviewCount||0};return"desktop"===t?Object(i.createElement)(e,{className:"yoast-shopping-data-preview--desktop"},Object(i.createElement)(E.ScreenReaderText,null,Object(u.__)("Shopping data preview:","wordpress-seo")),Object(i.createElement)(z,{shoppingData:o})):"mobile"===t?Object(i.createElement)(e,{className:"yoast-shopping-data-preview--mobile"},Object(i.createElement)(E.ScreenReaderText,null,Object(u.__)("Shopping data preview:","wordpress-seo")),Object(i.createElement)(K,{shoppingData:o})):null}render(){const{onMouseUp:e,onMouseLeave:t,onMouseEnter:n,mode:o,isAmp:r}=this.props,{PartContainer:s,Container:a,TitleUnbounded:l,SnippetTitle:c}=this.getPreparedComponents(o),p="desktop"===o,d=p||!r?null:Object(i.createElement)(Se,null);return Object(i.createElement)("section",null,Object(i.createElement)(a,{id:"yoast-snippet-preview-container",width:p?640:null,padding:20},Object(i.createElement)(s,null,this.renderUrl(),Object(i.createElement)(E.ScreenReaderText,null,Object(u.__)("SEO title preview","wordpress-seo")+":"),Object(i.createElement)(c,{onMouseUp:e.bind(null,"title"),onMouseEnter:n.bind(null,"title"),onMouseLeave:t.bind(null)},Object(i.createElement)(re,{screenMode:o},Object(i.createElement)(l,{ref:this.setTitleRef},this.getTitle()))),d),Object(i.createElement)(s,null,Object(i.createElement)(E.ScreenReaderText,null,Object(u.__)("Meta description preview:","wordpress-seo")),this.renderDescription()),this.renderProductData(s)))}getPreparedComponents(e){return{PartContainer:"desktop"===e?Ee:ve,Container:"desktop"===e?ee:te,TitleUnbounded:"desktop"===e?ae:le,SnippetTitle:this.addCaretStyles("title",ne)}}}Re.propTypes={title:c.a.string.isRequired,url:c.a.string.isRequired,siteName:c.a.string.isRequired,description:c.a.string.isRequired,date:c.a.string,breadcrumbs:c.a.array,hoveredField:c.a.string,activeField:c.a.string,keyword:c.a.string,wordsToHighlight:c.a.array,locale:c.a.string,mode:c.a.oneOf(X),isAmp:c.a.bool,faviconSrc:c.a.string,mobileImageSrc:c.a.string,shoppingData:c.a.object,onMouseUp:c.a.func.isRequired,onHover:c.a.func,onMouseEnter:c.a.func,onMouseLeave:c.a.func},Re.defaultProps={date:"",keyword:"",wordsToHighlight:[],breadcrumbs:null,locale:"en",hoveredField:"",activeField:"",mode:"mobile",isAmp:!1,faviconSrc:"",mobileImageSrc:"",shoppingData:{},onHover:()=>{},onMouseEnter:()=>{},onMouseLeave:()=>{}};const _e=c.a.shape({max:c.a.number,actual:c.a.number,score:c.a.number}),Me=a.a.input`
	border: none;
	width: 100%;
	height: inherit;
...
`;class Ie extends o.Component{constructor(e){super(e),this.switchToMobile=this.props.onChange.bind(this,"mobile"),this.switchToDesktop=this.props.onChange.bind(this,"desktop")}render(){const{active:e,mobileModeInputId:t,desktopModeInputId:n}=this.props,o=t.length>0?t:"yoast-google-preview-mode-mobile",r=n.length>0?n:"yoast-google-preview-mode-desktop";return Object(i.createElement)(ke,null,Object(i.createElement)(Ae,null,Object(u.__)("Preview as:","wordpress-seo")),Object(i.createElement)(Ne,{onChange:this.switchToMobile,type:"radio",name:"screen",value:"mobile",optionalAttributes:{id:o,checked:"mobile"===e}}),Object(i.createElement)(De,{for:o},Object(u.__)("Mobile result","wordpress-seo")),Object(i.createElement)(Ne,{onChange:this.switchToDesktop,type:"radio",name:"screen",value:"desktop",optionalAttributes:{id:r,checked:"desktop"===e}}),Object(i.createElement)(De,{for:r},Object(u.__)("Desktop result","wordpress-seo")))}}Ie.propTypes={onChange:c.a.func.isRequired,active:c.a.oneOf(X),mobileModeInputId:c.a.string,desktopModeInputId:c.a.string},Ie.defaultProps={active:"mobile",mobileModeInputId:"",desktopModeInputId:""};var Ve=Ie;const{MetaDescriptionLengthAssessment:Le,PageTitleWidthAssessment:Ue}=N.assessments.seo,{measureTextWidth:Be}=N.helpers,$e=a()(E.Button)`
	height: 33px;
